/*
package HW_Java.HW2011_11_02_generator;
...
public class Main {
    ...
    class Main {
        */
/*
        todo:Представьте, что в нашей программе мы обрабатываем массив (например, массив целых чисел или массив сотрудников, если хотите).
